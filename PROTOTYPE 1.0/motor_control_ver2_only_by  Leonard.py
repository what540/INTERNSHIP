...
SERIAL_PORT = 'COM11'  # Replace with your RS232C port
...
def main():
    ...
    try:
        # Set frequency of movements (e.g., times per 30 seconds)
        ...
        while True:
            ...
            position = random.randint(29000, 41000)  # Adjust range based on motor limits
            speed = random.randint(50, 250)     # Random speed
