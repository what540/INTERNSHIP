            ...
            while measuring:
                if arduinoData.in_waiting > 0:
                    ...
                    if len(data) ==7:
                        ...
                        laser_distance = laser_distance/10
                        laser_distance_rounded = round(laser_distance, 2)

                        ultra_distance_array.append(ultra_distance)
...
def clock_update():
    ...
    global ultra_distance_array, laser_distance_array

    print(time_string_array)
    print(ultra_distance_array)
    print(laser_distance_array)
